...
PIKE_DOC = tuple(_cpp.DOC_KEYWORDS)

#---- End Keyword Definitions ----#

#---- Syntax Style Specs ----#
SYNTAX_ITEMS = list(_cpp.SYNTAX_ITEMS)
...
def Properties(lang_id=0):
    ...
    """
    if lang_id == synglob.ID_LANG_PIKE:
        return _cpp.Properties(synglob.ID_LANG_CPP)
    else:
        return list()
...
def CommentPattern(lang_id=0):
    ...
    """
    if lang_id == synglob.ID_LANG_PIKE:
        return _cpp.CommentPattern(synglob.ID_LANG_CPP)
    else:
        return list()
